# Generated by Django 5.1.2 on 2024-11-24 03:29
...
def migrate_author_uuid(apps, schema_editor):
    Author = apps.get_model('node', 'Author')
    Post = apps.get_model('node', 'Post')
    Comment = apps.get_model('node', 'Comment')
    Image = apps.get_model('node', 'Image')
    
    # Migrate data in Author
    for author in Author.objects.all():
        author.uuid = uuid.uuid4()
        author.url = f"{author.host}authors/{author.uuid}"
        author.save(update_fields=['uuid', 'url'])

    # Migrate data in Post
    for post in Post.objects.all():
        post.author_uuid_id = post.author_id
        post.save(update_fields=['author_uuid_id'])
        
    # Migrate data in Comment
    for comment in Comment.objects.all():
        comment.author_uuid_id = comment.author_id
        comment.save(update_fields=['author_uuid_id'])
    
    # Migrate data in Image
    for image in Image.objects.all():
        image.author_uuid_id = image.author_id
        image.save(update_fields=['author_uuid_id'])
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_uuid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments_by_uuid', to=settings.AUTH_USER_MODEL, to_field='uuid')),
            ],
        ),
        migrations.CreateModel(
            name='CommentLike',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('author_uuid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='images_by_uuid', to=settings.AUTH_USER_MODEL, to_field='uuid')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('author_uuid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts_by_uuid', to=settings.AUTH_USER_MODEL, to_field='uuid')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
        ...
        migrations.RunPython(migrate_author_uuid),
    ]
