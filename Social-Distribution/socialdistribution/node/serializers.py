...
class AuthorSerializer(serializers.ModelSerializer):
    ...
    def get_page(self, obj):
        return f"https://darkgoldenrod/{obj.id}/profile"
...
class PostLikeSerializer(serializers.ModelSerializer):
    ...
    def get_id(self, obj):
        return f"https://darkgoldenrod/api/authors/{obj.author.id}/liked/{obj.id}"
    
    def get_object(self, obj):
        return f"https://darkgoldenrod/api/authors/{obj.owner.author.id}/posts/{obj.owner.id}"
...
class CommentLikeSerializer(serializers.ModelSerializer):
    ...
    def get_id(self, obj):
        return f"https://darkgoldenrod/api/authors/{obj.liker.id}/liked/{obj.object_id}"

    def get_object(self, obj):
        return f"https://darkgoldenrod/api/authors/{obj.owner.post.author.id}/posts/{obj.owner.post.id}/comments/{obj.owner.id}"
...
class PostLikesSerializer(serializers.Serializer):
    ...
    def get_page(self, obj):
        if hasattr(obj, 'post'):  
            return f"https://darkgoldenrod/authors/{obj.post.author.id}/posts/{obj.post.id}/comments/{obj.id}"
        else:  
            return f"https://darkgoldenrod/authors/{obj.author.id}/posts/{obj.id}"

    def get_id(self, obj):
        if hasattr(obj, 'post'):  
            return f"https://darkgoldenrod/api/authors/{obj.post.author.id}/posts/{obj.post.id}/comments/{obj.id}/likes"
        else:  
            return f"https://darkgoldenrod/api/authors/{obj.author.id}/posts/{obj.id}/likes"
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    def get_id(self, obj):
        return f"https://darkgoldenrod/api/authors/{obj.author.id}/commented/{obj.id}"

    def get_post(self, obj):
        return f"https://darkgoldenrod/api/authors/{obj.post.author.id}/posts/{obj.post.id}"
...
class CommentsSerializer(serializers.Serializer):
    ...
    def get_id(self, obj):
        return f"https://darkgoldenrod/api/authors/{obj.author.id}/posts/{obj.id}/comments"
...
#     def get_page(self, obj):
#         return f"https://darkgoldenrod/{str(obj.id)}/profile"
...
#     def get_id(self, obj):
#         return f"https://darkgoldenrod/api/authors/{str(obj.liker.id)}/liked/{str(obj.id)}"

#     def get_object(self, obj):
#         return f"https://darkgoldenrod/api/authors/{str(obj.owner.author.id)}/posts/{str(obj.owner.id)}"
...
#     def get_object(self, obj):
#         return (
#             f"https://darkgoldenrod/api/authors/{str(obj.owner.post.author.id)}"
...
#     def get_id(self, obj):
#         return f"https://darkgoldenrod/api/authors/{str(obj.author.id)}/comments/{str(obj.id)}"

#     def get_post(self, obj):
#         return f"https://darkgoldenrod/api/authors/{str(obj.post.author.id)}/posts/{str(obj.post.id)}"
...
#     def get_page(self, obj):
#         return f"https://darkgoldenrod/authors/{str(obj.author.id)}/posts/{str(obj.id)}"

#     def get_id(self, obj):
#         return f"https://darkgoldenrod/api/authors/{str(obj.author.id)}/posts/{str(obj.id)}/comments"
...
#     def get_id(self, obj):
#         return f"https://darkgoldenrod/api/authors/{str(obj.author.id)}/posts/{str(obj.id)}"
