...
urlpatterns = [
    ...
    path('node/authors/follow/<str:author_id>/', views.local_api_follow, name='follow_author'),  # New URL for follow action
    path('node/authors/unfollow/<str:author_id>/', views.unfollow_author, name='unfollow_author'),

    path("node/authors/<str:author_id>/followers/", views.followers_following_friends, name='followers'),
    path("node/authors/<str:author_id>/followings/", views.followers_following_friends, name='followings'),
    path("node/authors/<str:author_id>/friends/", views.followers_following_friends, name='friends'),

    path('node/authors/<str:author_id>/follower_requests/', views.follow_requests, name='follow_requests'),
    path('node/authors/<str:author_id>/follower_requests/approve/<int:follower_id>/', views.approve_follow, name='approve_follow'),
    path('node/authors/<str:author_id>/follower_requests/decline/<int:follower_id>/', views.decline_follow, name='decline_follow'),

    path("node/authors/<str:author_id>/profile/", views.profile, name='profile'),
    path("node/authors/<str:author_id>/profile/edit", views.edit_profile, name='profile_edit'),
    ...
    path('node/authors/<str:author_id>/posts', views.author_posts, name='author_posts'),
    path('node/authors/<str:author_id>/posts/<int:post_id>', views.api_get_post_from_author, name='api_get_post_from_author'),
    ...
    path('api/authors/<str:author_id>/posts/<int:post_id>', views.api_get_post_from_author, name='api_get_post_from_author'),
    path('api/authors/<str:author_id>/posts/<int:post_id>/likes', views.get_post_likes, name='get_post_likes'),
    path('api/token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),    
    ...
    path('api/authors/<str:author_id>/posts/<int:post_id>/comments', views.get_comments, name='get_comments'),
    path('api/authors/<str:author_id>/commented/<int:comment_id>', views.get_comment, name='get_comment'),
    ...
    path('api/authors/<str:author_id>/followers/<int:follower_id>/approve', views.followers_view, name='approve_follow'),
    ...
    path('api/authors/<str:author_id>/liked/<int:like_id>', views.get_like, name='get_like'),
